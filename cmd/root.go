...
to quickly create a Cobra application.`,
	...
	// 	fmt.Println("Hello from gracefulturnip!")
	// },
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.gracefulturnip.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".gracefulturnip" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".gracefulturnip")
	}
